...
<div class="product-detail accordion-detail">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="detail-info">
                ...
                <div class="clearfix product-price-cover">
                    <div class="product-price primary-color float-left">
                        <ins><span class="text-success text-brand">{{ format_price($product->front_sale_price_with_taxes) }}</span></ins>
                        @if ($product->front_sale_price !== $product->price)
                        <ins><span class="old-price font-md ml-15">{{ format_price($product->price_with_taxes) }}</span></ins>
                        <span class="save-price font-md text-success discount-pill color3 ml-15"><span class="percentage-off d-inline-block"> save {{ get_sale_percentage($product->price, $product->front_sale_price) }}</span> <span class="d-inline-block"></span></span>
                        @endif
                    </div>
                </div>
                ...
                <form class="add-to-cart-form" method="POST" action="{{ route('public.cart.add-to-cart') }}">
                    ...
                    <div class="detail-extralink mt-15">
                        ...
                        <a
                                ...
                                title="Contact us for custom rugs and inquiries">
                        ...
                        <div class="product-extra-link2 @if (EcommerceHelper::isQuickBuyButtonEnabled()) has-buy-now-button @endif">
                            ...
                            <button class="button button-buy-now  @if ($product->isOutOfStock()) btn-disabled @endif" type="submit" name="checkout" @if ($product->isOutOfStock()) disabled @endif><i class="far fa-bolt"></i>{{ __('Buy Now') }}</button>
                            @endif
                            @endif
                    ...
                    <div class="short-desc mb-30 mt-15">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="modal-product d-flex ">
                                ...
                                <div class="modal-product-img p-2px pb-0">
                                    <img class="default-img" src="{{ RvMedia::getImageUrl($product->image, 'product-thumb', false, RvMedia::getDefaultImage()) }}" alt="{{ $product->name }}">
                                </div>
                                <div class="modal-product-details single-product-details">
                                    <h3 class="modal-product-title mb-1 letter-spacing-0">
                                        {{ $product->name }}
                                    </h3>
                                    <div class="product-price">
                                        <span class="text-success bold">{{ format_price($product->front_sale_price_with_taxes) }}</span>
                                        @if ($product->front_sale_price !== $product->price)
                            ...
                            <form id="inquiryForm" class="modal-form-group">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="message" rows="3" placeholder="Example message" required></textarea>
                                </div>
                        ...
                        <div id="success-animation" class="success-animation" style="display:none; text-align:center;">
                            ...
                            <button type="button" class="btn" style="width: 100%;" data-bs-dismiss="modal">Continue shopping</button>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const iti = window.intlTelInput(input, {
                        initialCountry: "auto",
                        nationalMode: false, // ✅ this ensures full +countrycode is returned
                    ...
                    if (localStorage.getItem('inquiry_submitted_' + productId)) {
                    ...
                    form.addEventListener('submit', function(e) {
                        ...
                        fetch("{{ route('item-inquiry.store') }}", {
                                method: "POST",
                                headers: {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    modalFooter.style.display = 'none';
                                    successDiv.style.display = 'block';
                                    localStorage.setItem('inquiry_submitted_' + productId, 'true');
            ...
            <script type="module">
                ...
                new DotLottie({
                    ...
                    src: "{{ asset('lotties/success.json') }}", // or .json file
                    renderConfig: {
                        autoResize: true,
                        devicePixelRatio: 1,
                    },
    ...
    <div class="row mt-60" id="related-products">
        ...
        <div class="col-lg-{{ 12 / ($layout == 'product-full-width' ? 4 : 3) }} col-md-4 col-6 col-sm-6">
